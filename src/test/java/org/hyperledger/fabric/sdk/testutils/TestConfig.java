...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.caName", "ca-org1");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpcs://localhost:7051, peer1.org1.example.com@grpcs://localhost:8051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpcs://localhost:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpcs://localhost:7053,peer1.org1.example.com@grpcs://localhost:8053");
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.caName", "ca-org2");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpcs://localhost:9051,peer1.org2.example.com@grpcs://localhost:10051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpcs://localhost:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpcs://localhost:9053, peer1.org2.example.com@grpcs://localhost:10053");
